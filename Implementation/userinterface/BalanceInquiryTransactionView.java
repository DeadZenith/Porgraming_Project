...
public class BalanceInquiryTransactionView extends View
{
	...
	private JPanel createTitle()
	{
		...
		JLabel lbl = new JLabel(" Balance Inquiry Transaction ");
	...
	private void processAccountnumber(String accountNumber)
	{
		...
		myRegistry.updateSubscribers("DoBalanceInquiry", props);
	}
	...
	{
		myRegistry.updateSubscribers("CancelBalanceInquiry", null);
	}
...
//	Revision History:
//
//	$Log: BalanceInquiryTransactionView.java,v $
