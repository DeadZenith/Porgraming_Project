...
public class DepositReceipt extends View
{
	...
	private JLabel amountDeposited;
	...
	private JPanel createTitle()
	{
		...
		JLabel lbl = new JLabel(" Deposit Receipt ");
	...
	private JPanel createDataDisplayFields()
	{
		...
		JLabel amountDepositedLabel = new JLabel("Amount Deposited : ");
		temp2.add(amountDepositedLabel);

		amountDeposited = new JLabel("                       ");
		temp2.add(amountDeposited);
	...
	{
		// DEBUG: System.out.println("DepositReceipt.actionPerformed()");
