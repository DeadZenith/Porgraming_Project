...
public class SearchPatronsView extends View{
    // GUI components
    protected TextField patronSearch;
    ...
    //----------------------------------------------------------
    public SearchPatronsView(IModel patron)
    {
    ...
    private VBox createFormContent()
    {
        ...
        Text accNumLabel = new Text(" Patron ZipCode: ");
        ...
        patronSearch = new TextField();
        patronSearch.setEditable(true);
        grid.add(patronSearch, 1, 1);
    ...
    {
        patronSearch.setText((String)myModel.getState("patronSearch"));
    ...
    //---------------------------------------------------------
    public void processPatronSearchData() {
        String input = patronSearch.getText();
